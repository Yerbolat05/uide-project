    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.CharField(default='Караганда', max_length=9, verbose_name='Город')),
                ('email', models.EmailField(max_length=254, unique=True, verbose_name='Почта/Логин')),
                ('phone', models.CharField(default='87765372121', max_length=12, verbose_name='Номер телефона')),
                ('is_active', models.BooleanField(default=True, verbose_name='Активность')),
                ('is_staff', models.BooleanField(default=True, verbose_name='Статус менеджера')),
